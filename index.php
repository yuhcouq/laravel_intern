...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <!--     Fonts and icons     -->
	...
	if ($user){  
      $username = $user["name"];
      $lastlogin =  date('d/m/Y', strtotime($user["created_at"]));
      $balance = number_format($userbalance);
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Số đã sử dụng</p>
                      <p class="card-title"><?php echo $mynumbers; ?>
                        <p>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                  <a style="text-decoration:none; color:gray;" href="buy-number.php"><i class="fas fa-shopping-cart"></i>Thuê số ngay</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      <p class="card-category">Số dư tài khoản</p>
                      <p class="card-title"><?php echo $balance; ?> ₫
                        <p>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                <a style="text-decoration:none; color:gray;" href="add-balance.php"><i class="fas fa-plus"></i>Nạp tiền vào tài khoản</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card card-stats">
              <div class="card-body ">
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                    <p class="card-category">Hỗ trợ</p>
                      <p class="card-title"><?php echo $tickets; ?>
                        <p>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                <a style="text-decoration:none; color:gray;" href="open-ticket.php"><i class="fas fa-ticket-alt"></i>Yêu cầu hỗ trợ</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php echo $username; ?>
                        <p>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-footer ">
                <hr>
                <div class="stats">
                  <span style="color:gray;"><i class="fa fa-clock-o"></i> Ngày tham gia : <?php echo $lastlogin; ?></span>
                </div>
              </div>
            </div>
          </div>
