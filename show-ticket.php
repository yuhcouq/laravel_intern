          ...
          <div class="col-md-12">
            <div class="card card-plain">
              ...
              <hr>
                ...
                <p><span class=" text-primary">Öncelik :</span> <?php if($resultshowticket[0]["priority"] ==0){echo "Low";} elseif($resultshowticket[0]["priority"] ==1){echo "Middle";} elseif($resultshowticket[0]["priority"] ==2){echo "High";} ?></p>
                <button type="button" class="btn btn-info btn-block mt-2" data-toggle="collapse" data-target="#demo">Cevapla</button>
                ...
                <div class="card mt-2">
                            ...
                            <div class="card-body">
                                <form action="inc/replyticket.php" method="post">
